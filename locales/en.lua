Locales['en'] = {
  ...
  ['weapon_snspistol'] = 'Saturday Night Special',
  ...
  ['weapon_sawnoffshotgun'] = 'Service Less Lethal',
  ...
  ['weapon_marksmanrifle'] = 'SWAT Long Rifle',
  ...
  ['component_clip_default'] = 'Stock Clip',
